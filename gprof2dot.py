...
class CsvParser(LineParser):
    ...
    def parse_call(self, process, call_field):
        ...
        if not function_name or function_name == '[unknown]':
            function_name = "{}({})".format(mo.group('address'), os.path.basename(module))
...
class DotWriter:
    ...
    def graph(self, profile, theme):
        ...
        self.attr('node', fontname=fontname, shape="box", style=nodestyle, fontcolor=fontcolor, width=0, height=0,  fillcolor=fillcolor)
